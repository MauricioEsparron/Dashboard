...
public interface CursoMapper {
    ...
    @Mappings({
            ...
            @Mapping(source = "tipoMime", target = "typeMime"),
            @Mapping(source = "tamanio", target = "size"),
            @Mapping(source = "rutaArchivo", target = "filePath"),
            @Mapping(source = "urlPublica", target = "publicUrl"),
            @Mapping(source = "imageUrlBase64", target = "imgUrlBase64"),
